...
function enableTempChat()
  ...
  g_keyboard.unbindKeyUp("Space")
  g_keyboard.unbindKeyUp("Enter")
  local quickEfunc = function()
    disableTempChat()
	g_keyboard.useHotkeys = true
  end
  
  g_keyboard.bindKeyUp("Enter", quickEfunc)
...
function disableTempChat()
  local gameInterface = modules.game_interface

  consoleTextEdit:setVisible(false)
  consoleTextEdit:setText("")

  local quickDFunc = function()
    enableTempChat()
	g_keyboard.useHotkeys = false
  end
  g_keyboard.unbindKeyUp("Enter")
  g_keyboard.bindKeyUp("Space", quickDFunc)
  g_keyboard.bindKeyUp("Enter", quickDFunc)
