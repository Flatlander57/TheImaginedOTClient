  ...
  if creatureThing then
    ...
    if creatureThing:isLocalPlayer() then
      ...
      if creatureThing:isPlayer() then
        ...
        local localPlayerPshield = localPlayer:getPshield()
        local creaturePshield = creatureThing:getPshield()

        if localPlayerPshield == PshieldNone or localPlayerPshield == PshieldWhiteBlue then
          if creaturePshield == ShieldWhiteYellow then
        ...
        elseif localPlayerPshield == ShieldWhiteYellow then
          if creaturePshield == ShieldWhiteBlue then
        ...
        elseif localPlayerPshield == PshieldYellow or localPlayerPshield == PshieldYellowSharedExp or localPlayerPshield == PshieldYellowNoSharedExpBlink or localPlayerPshield == PshieldYellowNoSharedExp then
          if creaturePshield == PshieldWhiteBlue then
            menu:addOption(tr('Revoke %s\'s Invitation', creatureThing:getName()), function() g_game.partyRevokeInvitation(creatureThing:getId()) end)
          elseif creaturePshield == PshieldBlue or creaturePshield == PshieldBlueSharedExp or creaturePshield == PshieldBlueNoSharedExpBlink or creaturePshield == PshieldBlueNoSharedExp then
